...
function ReadInput() {
    ...
    if (data) {
        ...
        for (var i = 0; i < params.length; i++) {
            ...
            display += "<td><input type=\"button\" id=\"DeleteButton\" value=\" Delete \"  onclick=\"deleteRow(this)\"></td>";
            display += '</tr>';
        }
...
function CreateRow() {
    ...
    newColumn.innerHTML = " <select id=\"SelType\" size=\"3\" onchange=\"SelectChanging( this )\" ><option>String</option><option>Int</option><option>Boolean</option></select>"
...
function checkFieldForNumber(field) { 
    var start = field.value.selectionStart;
  ...
  //  
    ...
    fieldvalue.selectionEnd = index-1;
